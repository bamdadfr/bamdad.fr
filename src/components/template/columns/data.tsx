...
import Languages from '../../languages/controller'
...
const template = (key: number, payload: string, delay: number): ReactElement => {
    ...
    return <SpringText key={key} payload={payload} delay={delay} show />
    ...
    [
        ...
        (k: number): ReactElement => (
            <TextDiv key={k} className="is-size-4-desktop is-size-5-tablet is-size-5-mobile">
                <SpringText payload="i spend my time with" delay={7600} show overflow />
            </TextDiv>
        ),
    ],
]
